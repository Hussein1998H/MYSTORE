...
namespace MYSTORE.M_EntityFramework
{
    ...
    public partial class Manege_StoreEntities3 : DbContext
    {
        public Manege_StoreEntities3()
            : base("name=Manege_StoreEntities3")
        {
        }
        ...
        public virtual DbSet<Suppoler> Suppoler { get; set; }
